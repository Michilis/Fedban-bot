...
async def help_menu(client, message):
    await message.reply_text(
        ...
        "Then you need to start banning more, and more, and it gets painful. But then you have multiple groups, and you don't want these spammers in any of your groups - how can you deal? "
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Fed Admin Commands", callback_data="fed_admin_commands")],
                [InlineKeyboardButton("Federation Owner Commands", callback_data="federation_owner_commands")],
...
async def federation_owner_commands(client, callback_query):
    await callback_query.message.edit_text(
